...
| Subcommand                                               | Action                                                                                                                                                                                                                                                                                                   |
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| (empty) or `context`                                     | Collect project context. Each core file is capped at `context_max_bytes` (default 16 KB, `.mb-config` / `MB_CONTEXT_MAX_BYTES`); `--full` prints them whole                                                                                                                                                                                                                                                                                  |
