...
- [mb-work-cost-diet-sprint1](plans/2026-09-05_fix_mb-work-cost-diet-sprint1.md) — fix — mb-work-cost-diet · Sprint 1 «context-diet + измерение» — progress=59% stages(done=3,in_progress=0,planned=3,total=6)
