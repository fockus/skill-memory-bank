# roadmap.md — архив разделов (дословно, 2026-09-13)

Снято с `roadmap.md` при `/mb doctor` 2026-09-13: разделы устарели (закрытые планы, прошлые фокусы, legacy-план v3). Текст ниже — байт в байт, без правок.
