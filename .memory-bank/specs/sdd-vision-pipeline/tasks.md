...
**DoD:**
- [ ] README содержит credits-блок со ссылкой на репозиторий и MIT в том же блоке
- [ ] commands/discuss.md ссылается на источник grilling-паттернов с MIT-атрибуцией
- [ ] `bats tests/bats/test_mattpocock_attribution.bats` зелёный; на фикстуре «ссылка без MIT» — красный
<!-- /mb-task:1 -->
